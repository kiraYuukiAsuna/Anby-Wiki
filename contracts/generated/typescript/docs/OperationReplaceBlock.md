...
```typescript
import type { OperationReplaceBlock } from ''
...
const example = {
  ...
  "risk": null,
  "payload": null,
} satisfies OperationReplaceBlock
...
const exampleParsed = JSON.parse(exampleJSON) as OperationReplaceBlock
