...
export interface GetPageByIDRequest {
    id: string;
    contentMode?: GetPageByIDContentModeEnum;
}
...
export class ReadingApi extends runtime.BaseAPI {
    ...
    async getPageByIDRequestOpts(requestParameters: GetPageByIDRequest): Promise<runtime.RequestOpts> {
        ...
        if (requestParameters['contentMode'] != null) {
            queryParameters['content_mode'] = requestParameters['contentMode'];
        }
 ...
 * @export
 */
export const GetPageByIDContentModeEnum = {
    Auto: 'auto',
    Full: 'full',
    Sections: 'sections'
} as const;
export type GetPageByIDContentModeEnum = typeof GetPageByIDContentModeEnum[keyof typeof GetPageByIDContentModeEnum];
/**
 * @export
 */
export const GetPageByTitleContentModeEnum = {
    Auto: 'auto',
    Full: 'full',
    Sections: 'sections'
} as const;
