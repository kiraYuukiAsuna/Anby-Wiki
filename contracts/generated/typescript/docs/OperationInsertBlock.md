...
```typescript
import type { OperationInsertBlock } from ''
...
const example = {
  ...
  "risk": null,
  "payload": null,
} satisfies OperationInsertBlock
...
const exampleParsed = JSON.parse(exampleJSON) as OperationInsertBlock
