...
```typescript
import type { OperationRetargetPageReference } from ''
...
const example = {
  ...
  "risk": null,
  "payload": null,
} satisfies OperationRetargetPageReference
...
const exampleParsed = JSON.parse(exampleJSON) as OperationRetargetPageReference
