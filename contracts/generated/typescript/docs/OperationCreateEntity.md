...
```typescript
import type { OperationCreateEntity } from ''
...
const example = {
  ...
  "risk": null,
  "payload": null,
} satisfies OperationCreateEntity
...
const exampleParsed = JSON.parse(exampleJSON) as OperationCreateEntity
