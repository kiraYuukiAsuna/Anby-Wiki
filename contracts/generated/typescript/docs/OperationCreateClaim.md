...
```typescript
import type { OperationCreateClaim } from ''
...
const example = {
  ...
  "risk": null,
  "payload": null,
} satisfies OperationCreateClaim
...
const exampleParsed = JSON.parse(exampleJSON) as OperationCreateClaim
